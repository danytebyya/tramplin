...
CREATE TABLE applications (
    ...
    interview_start_time VARCHAR(16) NULL,
    interview_end_time VARCHAR(16) NULL,
    interview_format VARCHAR(255) NULL,
...
CREATE UNIQUE INDEX uq_applications_single_blocking ON applications (opportunity_id, applicant_user_id)
